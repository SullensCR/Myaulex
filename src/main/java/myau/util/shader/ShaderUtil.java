...
public class ShaderUtil {
    ...
    /**
     * Initialize using only fragment shader source code (uses default vertex shader)
    ...
    /**
     * Initialize using custom vertex and fragment shader source code
